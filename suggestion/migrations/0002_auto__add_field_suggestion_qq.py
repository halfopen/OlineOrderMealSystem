...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Suggestion.qq'
        db.add_column(u'suggestion_suggestion', 'qq',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Suggestion.qq'
        db.delete_column(u'suggestion_suggestion', 'qq')
    ...
    models = {
        ...
        u'suggestion.suggestion': {
            ...
            'qq': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
