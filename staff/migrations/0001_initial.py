...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Receptionlist'
        db.create_table(u'staff_receptionlist', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['staff.Staff'])),
        ))
        db.send_create_signal(u'staff', ['Receptionlist'])

        # Adding model 'HeadWaiter'
        db.create_table(u'staff_headwaiter', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['staff.Staff'])),
        ))
        db.send_create_signal(u'staff', ['HeadWaiter'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'Receptionlist'
        db.delete_table(u'staff_receptionlist')

        # Deleting model 'HeadWaiter'
        db.delete_table(u'staff_headwaiter')
