...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Staff', fields ['name']
        db.create_unique(u'staff_staff', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Staff', fields ['name']
        db.delete_unique(u'staff_staff', ['name'])
